...
${OBJECTDIR}/src/CFG/Config.o: src/CFG/Config.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -s -Isrc -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CFG/Config.o src/CFG/Config.cpp

${OBJECTDIR}/src/CFG/ConfigError.o: src/CFG/ConfigError.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/CFG
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -s -Isrc -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CFG/ConfigError.o src/CFG/ConfigError.cpp

${OBJECTDIR}/src/CFG/LEX/Lexer.o: src/CFG/LEX/Lexer.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/CFG/LEX
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -s -Isrc -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CFG/LEX/Lexer.o src/CFG/LEX/Lexer.cpp

${OBJECTDIR}/src/CFG/LEX/LexerError.o: src/CFG/LEX/LexerError.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/CFG/LEX
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -s -Isrc -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CFG/LEX/LexerError.o src/CFG/LEX/LexerError.cpp

${OBJECTDIR}/src/CFG/LEX/Token.o: src/CFG/LEX/Token.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/CFG/LEX
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -s -Isrc -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CFG/LEX/Token.o src/CFG/LEX/Token.cpp

${OBJECTDIR}/src/CFG/SEM/SemanticAnalyzer.o: src/CFG/SEM/SemanticAnalyzer.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/CFG/SEM
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -s -Isrc -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CFG/SEM/SemanticAnalyzer.o src/CFG/SEM/SemanticAnalyzer.cpp

${OBJECTDIR}/src/CFG/SEM/SemanticError.o: src/CFG/SEM/SemanticError.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/CFG/SEM
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -s -Isrc -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CFG/SEM/SemanticError.o src/CFG/SEM/SemanticError.cpp

${OBJECTDIR}/src/CFG/SYN/Expression.o: src/CFG/SYN/Expression.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/CFG/SYN
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -s -Isrc -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CFG/SYN/Expression.o src/CFG/SYN/Expression.cpp

${OBJECTDIR}/src/CFG/SYN/Parser.o: src/CFG/SYN/Parser.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/CFG/SYN
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -s -Isrc -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CFG/SYN/Parser.o src/CFG/SYN/Parser.cpp

${OBJECTDIR}/src/CFG/SYN/Property.o: src/CFG/SYN/Property.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/CFG/SYN
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -s -Isrc -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CFG/SYN/Property.o src/CFG/SYN/Property.cpp

${OBJECTDIR}/src/CFG/SYN/Scope.o: src/CFG/SYN/Scope.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/CFG/SYN
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -s -Isrc -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CFG/SYN/Scope.o src/CFG/SYN/Scope.cpp

${OBJECTDIR}/src/CFG/SYN/SyntaxError.o: src/CFG/SYN/SyntaxError.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/CFG/SYN
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -s -Isrc -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CFG/SYN/SyntaxError.o src/CFG/SYN/SyntaxError.cpp

${OBJECTDIR}/src/CFG/Value.o: src/CFG/Value.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/CFG
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -s -Isrc -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CFG/Value.o src/CFG/Value.cpp
...
${TESTDIR}/tests/ConfigTests.o: tests/ConfigTests.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -s -Isrc -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/ConfigTests.o tests/ConfigTests.cpp
...
${OBJECTDIR}/src/CFG/Config_nomain.o: ${OBJECTDIR}/src/CFG/Config.o src/CFG/Config.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Wall -s -Isrc -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CFG/Config_nomain.o src/CFG/Config.cpp;\
	else  \
...
${OBJECTDIR}/src/CFG/ConfigError_nomain.o: ${OBJECTDIR}/src/CFG/ConfigError.o src/CFG/ConfigError.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Wall -s -Isrc -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CFG/ConfigError_nomain.o src/CFG/ConfigError.cpp;\
	else  \
...
${OBJECTDIR}/src/CFG/LEX/Lexer_nomain.o: ${OBJECTDIR}/src/CFG/LEX/Lexer.o src/CFG/LEX/Lexer.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Wall -s -Isrc -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CFG/LEX/Lexer_nomain.o src/CFG/LEX/Lexer.cpp;\
	else  \
...
${OBJECTDIR}/src/CFG/LEX/LexerError_nomain.o: ${OBJECTDIR}/src/CFG/LEX/LexerError.o src/CFG/LEX/LexerError.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Wall -s -Isrc -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CFG/LEX/LexerError_nomain.o src/CFG/LEX/LexerError.cpp;\
	else  \
...
${OBJECTDIR}/src/CFG/LEX/Token_nomain.o: ${OBJECTDIR}/src/CFG/LEX/Token.o src/CFG/LEX/Token.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Wall -s -Isrc -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CFG/LEX/Token_nomain.o src/CFG/LEX/Token.cpp;\
	else  \
...
${OBJECTDIR}/src/CFG/SEM/SemanticAnalyzer_nomain.o: ${OBJECTDIR}/src/CFG/SEM/SemanticAnalyzer.o src/CFG/SEM/SemanticAnalyzer.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Wall -s -Isrc -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CFG/SEM/SemanticAnalyzer_nomain.o src/CFG/SEM/SemanticAnalyzer.cpp;\
	else  \
...
${OBJECTDIR}/src/CFG/SEM/SemanticError_nomain.o: ${OBJECTDIR}/src/CFG/SEM/SemanticError.o src/CFG/SEM/SemanticError.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Wall -s -Isrc -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CFG/SEM/SemanticError_nomain.o src/CFG/SEM/SemanticError.cpp;\
	else  \
...
${OBJECTDIR}/src/CFG/SYN/Expression_nomain.o: ${OBJECTDIR}/src/CFG/SYN/Expression.o src/CFG/SYN/Expression.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Wall -s -Isrc -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CFG/SYN/Expression_nomain.o src/CFG/SYN/Expression.cpp;\
	else  \
...
${OBJECTDIR}/src/CFG/SYN/Parser_nomain.o: ${OBJECTDIR}/src/CFG/SYN/Parser.o src/CFG/SYN/Parser.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Wall -s -Isrc -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CFG/SYN/Parser_nomain.o src/CFG/SYN/Parser.cpp;\
	else  \
...
${OBJECTDIR}/src/CFG/SYN/Property_nomain.o: ${OBJECTDIR}/src/CFG/SYN/Property.o src/CFG/SYN/Property.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Wall -s -Isrc -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CFG/SYN/Property_nomain.o src/CFG/SYN/Property.cpp;\
	else  \
...
${OBJECTDIR}/src/CFG/SYN/Scope_nomain.o: ${OBJECTDIR}/src/CFG/SYN/Scope.o src/CFG/SYN/Scope.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Wall -s -Isrc -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CFG/SYN/Scope_nomain.o src/CFG/SYN/Scope.cpp;\
	else  \
...
${OBJECTDIR}/src/CFG/SYN/SyntaxError_nomain.o: ${OBJECTDIR}/src/CFG/SYN/SyntaxError.o src/CFG/SYN/SyntaxError.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Wall -s -Isrc -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CFG/SYN/SyntaxError_nomain.o src/CFG/SYN/SyntaxError.cpp;\
	else  \
...
${OBJECTDIR}/src/CFG/Value_nomain.o: ${OBJECTDIR}/src/CFG/Value.o src/CFG/Value.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Wall -s -Isrc -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CFG/Value_nomain.o src/CFG/Value.cpp;\
	else  \
